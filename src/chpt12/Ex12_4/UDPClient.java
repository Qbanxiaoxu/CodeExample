...
public class UDPClient {  
	...
	public UDPClient() throws IOException{
		...
		DatagramSocket ds = new DatagramSocket(5555);//创建DatagramSocket对象，并绑定端口5555  
      ...
      //创建标准输入BufferedReader对象
        ...
        //创建用于发送数据的DatagramPacket对象 ，指定接收放的端口号4444
        DatagramPacket dpSend= new DatagramPacket(line.getBytes(),line.length(),loc,4444);  
