...
CREATE TABLE `desktop` (
  ...
  `ProcessSpeed` double DEFAULT NULL,
  `Memory` int(11) DEFAULT NULL,
  `MonitorSize` int(11) DEFAULT NULL,
  PRIMARY KEY (`ID`)
...
INSERT INTO `desktop` VALUES (1,'Dell',8000,'MSN Product','Intel i3 4020Y',4000,4,13),(2,'Lenovo',9000,'Apple Product','Intel P8800',6000,4,15);
