...
CREATE TABLE `laptop` (
  ...
  `ProcessorName` varchar(45) DEFAULT NULL,
...
INSERT INTO `laptop` VALUES (1,'ThinkPad',5000,'Windows 8 OS','ThinkPadE450C(20EH0001CD',4000,2,15,4),(2,'ASUS',4900,'Winddow 10 OS','ASUSFX50JX',5000,4,13,6);
